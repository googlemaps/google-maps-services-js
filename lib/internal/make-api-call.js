...
exports.inject = function(options) {
   ...
   * }}
   * @param {Object} customParams - Unsupported and for advanced usage only.
   */
  return function(path, query, callback, customParams) {
    ...
    var requestUrl = formatRequestUrl(path, query, customParams, useClientId);
   ...
   */
  function formatRequestUrl(path, query, customParams, useClientId) {
    if (channel) {
