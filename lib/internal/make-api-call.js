...
exports.inject = function(options) {
  ...
  return function(path, query, callback) {
    ...
    var promise, pResolve, pReject;
    if (options.Promise) {
      promise = new options.Promise(function(resolve, reject) {
        pResolve = resolve;
        pReject = reject;
      });
    }
      ...
      'do': function() {
        return requestQueue.add(function() {
          return Task.do(function(callback) {
            var handle = makeUrlRequest(requestUrl, callback);
    ...
    if (promise) {
      handle.asPromise = function() { return promise; };
    }
    return handle;
  };
};
