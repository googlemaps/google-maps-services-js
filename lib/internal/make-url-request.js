 ...
 * }
 *
 * Returns a handle object, which has a cancel() method. Cancelled requests
 * invoke the error callback with the value
 *     new Error('cancelled')
 *
 * @param {string} url
 * @param {Function} callback
 * @return {{cancel: function()}} A handle object with a cancel method.
 */
